...
CREATE TABLE `dep_emp` (
  ...
  `dept_no` char(3) DEFAULT NULL,
  `from_date` date DEFAULT NULL,
  `to_date` date DEFAULT NULL,
  KEY `emp_no` (`emp_no`),
  KEY `dept_no` (`dept_no`),
  CONSTRAINT `dep_emp_ibfk_1` FOREIGN KEY (`emp_no`) REFERENCES `employees` (`emp_no`),
  CONSTRAINT `dep_emp_ibfk_2` FOREIGN KEY (`dept_no`) REFERENCES `departments` (`dept_no`)
...
CREATE TABLE `dep_manager` (
  ...
  KEY `emp_no` (`emp_no`),
  KEY `dept_no` (`dept_no`),
  CONSTRAINT `dep_manager_ibfk_1` FOREIGN KEY (`emp_no`) REFERENCES `employees` (`emp_no`),
  CONSTRAINT `dep_manager_ibfk_2` FOREIGN KEY (`dept_no`) REFERENCES `departments` (`dept_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-09-16 12:04:45
-- MySQL dump 10.13  Distrib 8.0.30, for Win64 (x86_64)
--
...
CREATE TABLE `register` (
  ...
  `cotact_no` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2022-09-16 12:04:46
-- MySQL dump 10.13  Distrib 8.0.30, for Win64 (x86_64)
--
...
-- Dump completed on 2022-09-16 12:04:47
-- MySQL dump 10.13  Distrib 8.0.30, for Win64 (x86_64)
--
...
CREATE TABLE `employee_details` (
  ...
  `dateof_join` varchar(45) DEFAULT NULL,
  `yearof_exp` varchar(45) DEFAULT NULL,
...
-- MySQL dump 10.13  Distrib 8.0.30, for Win64 (x86_64)
--
-- Host: localhost    Database: result1
-- ------------------------------------------------------
-- Server version	8.0.30
...
CREATE TABLE `courses` (
  ...
  CONSTRAINT `roll_number` FOREIGN KEY (`roll_number`) REFERENCES `student` (`student_id`)
...
CREATE TABLE `student` (
  ...
  `counry` varchar(45) DEFAULT NULL,
...
-- MySQL dump 10.13  Distrib 8.0.30, for Win64 (x86_64)
--
-- Host: localhost    Database: abhijit
-- ------------------------------------------------------
-- Server version	8.0.30
...
--
-- Table structure for table `petiont`
--

DROP TABLE IF EXISTS `petiont`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `petiont` (
  `pid` int NOT NULL AUTO_INCREMENT,
  `pname` varchar(45) DEFAULT NULL,
  `group_id` varchar(45) DEFAULT NULL,
  `page` int DEFAULT NULL,
  PRIMARY KEY (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=4523547 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-09-16 12:04:48
